...
"Seek meaning and connection in ideas, relationships, and material possessions. Want to understand "
        + "\nwhat motivates people and are insightful about others. Conscientious and committed to their "
        + "\nfirm values. Develop a clear vision about how best to serve the common good. Organized and "
...
"Have original minds and great drive for implementing their ideas and achieving their goals. Quickly "
        + "\nsee patterns in external events and develop long-range explanatory perspectives. When "
...
"Tolerant and flexible, quiet observers until a problem appears, then act quickly to find workable solutions. "
        + "\nAnalyze what makes things work and readily get through large amounts of data to isolate the core "
...
"Quiet, friendly, sensitive, and kind. Enjoy the present moment, what's going on around them. Like to have"
        + "\n their own space and to work within their own time frame. Loyal and committed to their values"
        + "\n and to people who are important to them. Dislike disagreements and conflicts, do not force "
...
"Seek to develop logical explanations for everything that interests them. Theoretical and abstract, interested "
        + "\nmore in ideas than in social interaction. Quiet, contained, flexible, and adaptable. Have unusual "
        + "\nability to focus in depth to solve problems in their area of interest. Skeptical, sometimes "
...
"Flexible and tolerant, they take a pragmatic approach focused on immediate results. Theories and conceptual "
        + "\nexplanations bore them - they want to act energetically to solve the problem. Focus on the here-"
...
"Outgoing, friendly, and accepting. Exuberant lovers of life, people, and material comforts. Enjoy working with "
        + "\nothers to make things happen. Bring common sense and a realistic approach to their work, and make "
        + "\nwork fun. Flexible and spontaneous, adapt readily to new people and environments. Learn best by trying "
...
"Warmly enthusiastic and imaginative. See life as full of possibilities. Make connections between events and "
        + "\ninformation very quickly, and confidently proceed based on the patterns they see. Want a lot of "
...
"\n" +
"ENTP\n" +
"Quick, ingenious, stimulating, alert, and outspoken. Resourceful in solving new and challenging problems. Adept "
        + "\nat generating conceptual possibilities and then analyzing them strategically. Good at reading other "
        + "\npeople. Bored by routine, will seldom do the same thing the same way, apt to turn to one new interest "
        + "\nafter another.\n" +
"\n" +
"ESTJ\n" +
"Practical, realistic, matter-of-fact. Decisive, quickly move to implement decisions. Organize projects and "
        + "\npeople to get things done, focus on getting results in the most efficient way possible. Take care "
        + "\nof routine details. Have a clear set of logical standards, systematically follow them and want "
...
"Warmhearted, conscientious, and cooperative. Want harmony in their environment, work with determination to "
        + "\nestablish it. Like to work with others to complete tasks accurately and on time. Loyal, follow through "
        + "\neven in small matters. Notice what others need in their day-by-day lives and try to provide it. Want to be "
...
"Warm, empathetic, responsive, and responsible. Highly attuned to the emotions, needs, and motivations of others. Find "
        ...
        + "\ngroup growth. Loyal, responsive to praise and criticism. Sociable, facilitate others in a group, and provide "
...
"Frank, decisive, assume leadership readily. Quickly see illogical and inefficient procedures and policies, develop "
        ...
        + "\nsetting. Usually well informed, well read, enjoy expanding their knowledge and passing it on to others. "
